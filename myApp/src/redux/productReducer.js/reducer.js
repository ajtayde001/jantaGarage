import {
  ...
  GET_ADHIKARI_SUCCESS,
  GET_ATTEND_SUCCESS,
  GET_CatTotal_SUCCESS,
  GET_Categories_SUCCESS,
  GET_DEVELOPMENT_SUCCESS,
  GET_FILTERVISITORS_SUCCESS,
  GET_INPROGRESSDATA_SUCCESS,
  GET_INWARDOUT_SUCCESS,
  GET_KARYKARTA_SUCCESS,
  GET_MASTERVISIT_SUCCESS,
  GET_OFFICE_SUCCESS,
  GET_ONHOLDDATA_SUCCESS,
  GET_PRODUCT_SUCCESS,
  GET_QUEUEDATA_SUCCESS,
  GET_SOLVEDDATA_SUCCESS,
  GET_STATUSUPDATEDATA_SUCCESS,
  GET_STATUS_SUCCESS,
  GET_TODAYEVENT_SUCCESS,
  GET_USERSEARCH_SUCCESS,
  GET_VISITORS_SUCCESS,
  GET_assemblies_SUCCESS,
  PATCH_PRODUCT_SUCCESS,
  POST_COMMENT_SUCCESS,
  POST_COMPLAINER_SUCCESS,
  POST_COMPLAINTE_SUCCESS,
  PRODUCT_FAILURE,
  PRODUCT_REQUEST,
} from "./actiontype";
...
export const reducer = (state = initialstate, { type, payload }) => {
  switch (type) {
    ...
    case POST_COMPLAINER_SUCCESS:
      return { ...state, isLoading: false, complainerSinleData: payload };
    ...
    case GET_MASTERVISIT_SUCCESS:
      return { ...state, isLoading: false, mastervisit: payload };
    case GET_VISITORS_SUCCESS:
      return { ...state, isLoading: false, visitors: payload };

    case GET_FILTERVISITORS_SUCCESS:
      return { ...state, isLoading: false, purposevisitor: payload };
    case DELETE_PRODUCT_SUCCESS:
      return {
        ...state,
        isLoading: false,
        deleteItem: [...state.deleteItem, payload],
      };
    default:
      return initialstate;
  }
