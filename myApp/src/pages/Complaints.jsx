...
const Complaints = () => {
 ...
 const dispatch = useDispatch();
  ...
  const hnadleSearch = (e) => {
    ...
    dispatch(getProductDAta(pros, yourConfig));
    dispatch(getInProgressDAta(pros, yourConfig));
    dispatch(getSolvedDAta(pros, yourConfig));
    dispatch(getOnHoldDAta(pros, yourConfig));
    dispatch(getQueueDAta(pros, yourConfig));
    dispatch(getStatusUpdateDAta(pros, yourConfig));
    // setSearchdata("")
...
const typdata = caterf ? caterf.types : [];
 const typKaObj = typ ? JSON.parse(typ) : {};
  ...
  const handleFilter = () => {
    ...
    dispatch(getProductDAta(mainData1, yourConfig));
    
    dispatch(getInProgressDAta(mainData1, yourConfig));
    
    dispatch(getSolvedDAta(mainData1, yourConfig));
    
    dispatch(getOnHoldDAta(mainData1, yourConfig));
    
    dispatch(getQueueDAta(mainData1, yourConfig));
    
    dispatch(getStatusUpdateDAta(mainData1, yourConfig));
